Public Class COVID
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            ob.con.Close()
            MsgBox("Product added to cart", MsgBoxStyle.Exclamation)
        End If
    ...
    Protected Sub itemSelected(sender As Object, e As EventArgs) Handles DropDownList1.SelectedIndexChanged
