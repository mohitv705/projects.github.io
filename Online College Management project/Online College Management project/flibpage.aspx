<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="flibpage.aspx.vb" Inherits="Online_College_Management_project.flibpage" %>
...
<body>
    ...
    <div class="style1">
        ...
        <asp:LinkButton ID="LinkButton2" runat="server" CssClass="style7">Back to dashboard</asp:LinkButton>
    ...
    CssClass="style18" BorderColor="Black" ReadOnly="True"></asp:TextBox>
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="style8" 
            PostBackUrl="~/fdashboard.aspx">Go back </asp:LinkButton>
    
        <asp:Panel ID="Panel2" runat="server" CssClass="style17" Visible="False">
