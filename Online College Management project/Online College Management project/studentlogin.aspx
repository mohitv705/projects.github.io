<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="studentlogin.aspx.vb" Inherits="Online_College_Management_project.studentlogin" %>
...
<body>
    ...
    <div class="style1" align="center" style="background-color: #FFFF66">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#FF9933" CssClass="style7">
    ...
    CssClass="style8" BackColor="Yellow" BorderColor="Black"></asp:TextBox>
        ...
        <asp:Label ID="Label3" runat="server" CssClass="style13" 
            ...
            Font-Size="XX-Large" Font-Underline="True" Text="LOGIN"></asp:Label>
