<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="admerror.aspx.vb" Inherits="Online_College_Management_project.admerror" %>
...
<body>
    ...
    <div class="style1">
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" BackColor="#99FF66" 
            CssClass="style3" PostBackUrl="~/adminlogin.aspx">Click here to go back and login again</asp:LinkButton>
