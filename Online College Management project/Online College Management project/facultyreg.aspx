<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="facultyreg.aspx.vb" Inherits="Online_College_Management_project.facultyreg" %>
...
<body style="height: 594px; width: 1275px; position: absolute; left: 21px; top: -3px;">
    ...
    <div align="center" class="style1" dir="ltr" 
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
            ControlToValidate="TextBox1" CssClass="style41" 
            ErrorMessage="Name should contain alphabets only" ForeColor="Red" 
